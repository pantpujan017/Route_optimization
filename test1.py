...
def create_single_place_map(place, city_coordinates, path):
    """Create a map showing only the selected place along with the route."""
    ...
    district_coords = city_coordinates[place['district']]
    ...
    <div style="position: fixed; 
        ...
        <p><i class="fa fa-info-sign" style="color:orange"></i> Selected Place</p>
